...
Link Python to the database by creating a SQLAlchemy session. Remember to close your session at the end of your notebook.
...
And only returns the jsonified data for the last year of data (3 points)	
